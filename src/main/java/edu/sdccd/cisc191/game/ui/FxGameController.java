...
public class FxGameController {
    ...
    private void refreshMatches() {
        statusLabel.setText("Refresh Matches clicked");
    }

    @FXML
    private void refreshLeaderboard() {
        statusLabel.setText("Refresh Leaderboard clicked");
    }

    @FXML
    private void getMatchById() {
        statusLabel.setText("Get Match clicked");
    }

    @FXML
    private void deleteMatch() {
        statusLabel.setText("Delete Match clicked");
    }
}